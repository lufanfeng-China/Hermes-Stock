...
def build_relative_valuation_result(market: str, symbol: str) -> dict[str, object]:
    ...
    return {
        ...
        "industry_free_float_weighted_pe_ttm": _to_float(industry_snapshot.get("free_float_weighted_pe_ttm")),
        "industry_free_float_weighted_ps_ttm": _to_float(industry_snapshot.get("free_float_weighted_ps_ttm")),
        "dynamic_pe_invalid_threshold": dynamic_threshold,
