...
class SearchIndexTests(unittest.TestCase):
    ...
    def test_build_stock_profile_includes_rps_metrics(self) -> None:
        ...
        self.assertAlmostEqual((60.76 + 82.35) / 2, profile["industry_rps_20"])
        self.assertAlmostEqual((48.97 + 52.12) / 2, profile["industry_rps_50"])
        self.assertIsNone(profile["industry_rps_120"])
        self.assertIsNone(profile["industry_rps_250"])
